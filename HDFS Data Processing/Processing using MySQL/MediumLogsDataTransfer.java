...
public class MediumLogsDataTransfer extends Connector{
	...
	public static void insertRecords(ArrayList<ArrayList<String>> inputRecords) throws SQLException{
		mysql = "INSERT INTO WEBLOGS.MEDIUM_LOGS(Log_Date, Log_Time, Log_Path, Log_Type, Log_Webfile, Log_Number1, Log_IPAddress, Log_Number2, Log_Number3, Log_Systembit, Log_Number4) VALUES " + "(?,?,?,?,?,?,?,?,?,?,?)";
		try{
	...
	public static void main(String[] args) throws IOException{
		try{
			file = new FileInputStream("/home/vagrant/finalproject_files/logs-2015.log");
