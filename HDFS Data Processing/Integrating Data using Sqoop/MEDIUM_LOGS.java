// ORM class for table 'MEDIUM_LOGS'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Apr 29 23:05:45 UTC 2017
...
public class MEDIUM_LOGS extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  protected ResultSet __cur_result_set;
  private Integer ML_Id;
  public Integer get_ML_Id() {
    return ML_Id;
  }
  public void set_ML_Id(Integer ML_Id) {
    this.ML_Id = ML_Id;
  }
  public MEDIUM_LOGS with_ML_Id(Integer ML_Id) {
    this.ML_Id = ML_Id;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Date(java.sql.Date Log_Date) {
    this.Log_Date = Log_Date;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Time(String Log_Time) {
    this.Log_Time = Log_Time;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Path(String Log_Path) {
    this.Log_Path = Log_Path;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Type(String Log_Type) {
    this.Log_Type = Log_Type;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Webfile(String Log_Webfile) {
    this.Log_Webfile = Log_Webfile;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Number1(Integer Log_Number1) {
    this.Log_Number1 = Log_Number1;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_IPAddress(String Log_IPAddress) {
    this.Log_IPAddress = Log_IPAddress;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Number2(Integer Log_Number2) {
    this.Log_Number2 = Log_Number2;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Number3(Integer Log_Number3) {
    this.Log_Number3 = Log_Number3;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Systembit(Integer Log_Systembit) {
    this.Log_Systembit = Log_Systembit;
    return this;
  }
  ...
  public MEDIUM_LOGS with_Log_Number4(Integer Log_Number4) {
    this.Log_Number4 = Log_Number4;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MEDIUM_LOGS)) {
      return false;
    }
    MEDIUM_LOGS that = (MEDIUM_LOGS) o;
    boolean equal = true;
    equal = equal && (this.ML_Id == null ? that.ML_Id == null : this.ML_Id.equals(that.ML_Id));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.ML_Id = JdbcWritableBridge.readInteger(1, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(ML_Id, 1 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.ML_Id = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.Log_Date = null;
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(ML_Id==null?"null":"" + ML_Id, delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.ML_Id = null; } else {
      this.ML_Id = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    MEDIUM_LOGS o = (MEDIUM_LOGS) super.clone();
    o.Log_Date = (o.Log_Date != null) ? (java.sql.Date) o.Log_Date.clone() : null;
    return o;
  }

  public void clone0(MEDIUM_LOGS o) throws CloneNotSupportedException {
    o.Log_Date = (o.Log_Date != null) ? (java.sql.Date) o.Log_Date.clone() : null;
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new TreeMap<String, Object>();
    __sqoop$field_map.put("ML_Id", this.ML_Id);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("ML_Id".equals(__fieldName)) {
      this.ML_Id = (Integer) __fieldVal;
    }
